            ...
            {berkasTypes.map((type, index) => {
              ...
              return (
                <div key={type.key} className="border border-gray-200 rounded-lg p-4 w-full overflow-hidden">
                  <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4 overflow-x-hidden">
                    <div className="flex-1 min-w-0">
                      <h3 className="font-medium text-gray-900">{type.label}</h3>
                      {berkas && (
                        <div className="mt-1 flex items-center gap-2 min-w-0">
                          <p className="text-sm text-gray-600 text-pretty break-all">{berkas.nama_file}</p>
                    ...
                    <div className="flex items-center gap-3 flex-shrink-0">
                      ...
                      <label
                        ...
                        className={`px-4 py-2 rounded-lg text-sm font-medium cursor-pointer transition-colors ${isUploading
